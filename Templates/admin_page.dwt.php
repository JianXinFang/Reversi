...
<div style="position:relative;top:70px;" align="center">
  <table width="1092" border="0">
    <tr>
      <td width="236" align="center"><span style="text-align: left; font-size: 30pt;"><a href="admin_home.php">Admin Home</a>&nbsp;</span></td>
      <td width="10" align="center"><img src="imgs/menu div.png" width="10" height="50" /></td>
      <td width="282" align="center"><span style="text-align: left; font-size: 30pt;">&nbsp;<a href="manage_users.php">Manage Users&nbsp;</a></span></td>
      <td width="10" align="center"><img src="imgs/menu div.png" alt="" width="10" height="50" /></td>
      <td width="392" align="center"><span style="text-align: left; font-size: 30pt;">&nbsp;<a href="manage_tournament.php">Manage Tournament</a></span></td>
      <td width="14" align="center"><img src="imgs/menu div.png" alt="" width="10" height="50" /></td>
      <td width="118" align="center"><span style="text-align: left; font-size: 30pt;">&nbsp;<a href="cms.php">CMS</a></span></td>

    </tr>
  </table>
</div>
<div style="position:relative;top:65px;height:1280px;" align="center"><!-- TemplateBeginEditable name="content_area" -->aaa <!-- TemplateEndEditable --></div>
